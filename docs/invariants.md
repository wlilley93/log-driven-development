...
**Enforced at.** `skills/ledger-driven-development/SKILL.md:82` (rule), `:35-37`, `:114-116`;
...
`skills/ledger-driven-development/SKILL.md:91-93`; `docs/systems.md:265-266`; the harvest template
...
**Enforced at.** `skills/ledger-driven-development/SKILL.md:83` (rule), `:48-50`, `:117-119`;
...
**Enforced at.** `skills/ledger-driven-development/SKILL.md:84` (rule), `:67-68`, `:120-123`;
...
**Enforced at.** `skills/ledger-driven-development/SKILL.md:86` (rule), `:46-47`, `:165-166`;
...
**Enforced at.** `skills/ledger-driven-development/SKILL.md:87` (rule), `:44-45`, `:61`;
...
**Enforced at.** `skills/ledger-driven-development/SKILL.md:88` (rule), `:58`, `:124-128`;
...
**Enforced at.** `skills/ledger-driven-development/SKILL.md:134-135` (rule); `docs/methodology.md:226-231`;
...
**Enforced at.** `skills/ledger-driven-development/SKILL.md:129-132` (the closure-gate discipline);
...
`skills/ledger-driven-development/SKILL.md:129-133`; `tools/closure-gate/closure_gate.py:5-8`;
...
**Enforced at.** `skills/ledger-driven-development/SKILL.md:108-109`; `docs/methodology.md:104-118`;
...
**Enforced at.** `skills/ledger-driven-development/SKILL.md:149-162`; `docs/methodology.md:264-289`;
...
**Enforced at.** `skills/ledger-driven-development/SKILL.md:90-93` (the intent-ledger spine, to gain the two named
...
**Enforced at.** `skills/ledger-driven-development/SKILL.md:96-97,173-174`; `docs/methodology.md:148-151,164-169`;
...
**Enforced at.** `skills/ledger-driven-development/SKILL.md:53-61`; `skills/council/SKILL.md:22-36,78-110`;
