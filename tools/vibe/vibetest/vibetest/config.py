"""Configuration loader — .vibetest.yml parsing, defaults, validation."""
...
DEFAULT_CONFIG_NAME = ".vibetest.yml"
    ...
    **overrides: Any,
    ...
    for runner_name, runner_raw in runners_raw.items():
        if isinstance(runner_raw, dict):
            ...
            config.runner_configs[runner_name] = RunnerConfig(enabled=enabled, extra=runner_raw)
